    ...
    <div class="space-y-6 animate-fade-in">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-gray-500">Statistika va tahlillar</p>
        </div>
      ...
      <div class="bg-white rounded-2xl shadow-card border border-gray-100 p-8">
        <div class="text-center py-12">
          <ChartBarIcon class="w-16 h-16 text-gray-300 mx-auto" />
          <h3 class="mt-4 text-lg font-medium text-gray-900">Hisobotlar tez orada</h3>
          <p class="mt-2 text-gray-500">Hisobotlar moduli ishlab chiqilmoqda</p>
        </div>
      </div>
    </div>
  </MainLayout>
