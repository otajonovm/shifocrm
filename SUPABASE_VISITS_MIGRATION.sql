-- Visits Table Migration for Supabase
-- Tashriflar jadvalini yaratish
...
-- 4. Debt_amount avtomatik hisoblash trigger (ixtiyoriy)
-- Agar price va paid_amount o'zgarsa, debt_amount ni avtomatik hisobla
...
-- Variant 1: Public access (anon key bilan ishlash uchun)
-- Agar authentication ishlatilmasa, bu policies'ni ishlating
...
-- Variant 2: Authenticated users uchun (agar authentication ishlatilsa)
-- Quyidagi policies'ni faqat Variant 1 o'chirilgandan keyin ishlating
...
-- Admin barcha visitlarni yarata/yangilay/ochira oladi
...
-- Doctor o'z visitlarini yarata/yangilay oladi
